...
deleteEducationButton.addEventListener("click", function () {
  if (educationCount > 0) {
    var educationList = document.getElementById("educationList");
    var education = document.getElementById("education" + (educationCount - 1));
...
addExperienceButton.addEventListener("click", function () {
  ...
  addButton.addEventListener("click", function () {
    ...
    newLine.appendChild(
      document.createTextNode("Bullet " + (expBullets[currDivId] + 1) + ": ")
    );
...
addProjectButton.addEventListener("click", function () {
  ...
  addButton.addEventListener("click", function () {
    ...
    newLine.appendChild(
      document.createTextNode("Bullet " + (projBullets[currDivId] + 1) + ": ")
    );
    newLine.appendChild(newBullet);
    currDiv.appendChild(newLine);
  ...
  for (let i = 0; i < experienceList.length; i++) {
    ...
    for (let j = 0; j < expBullets[experienceList[i].id]; j++) {
      experienceObject["bullets"].push(
        document.getElementById("e" + i + "b" + j).value.replaceAll("%", "\\%")
      );
    }
  ...
  for (let i = 0; i < projectList.length; i++) {
    ...
    for (let j = 0; j < projBullets[project.id]; j++) {
      projectObject["bullets"].push(
        document.getElementById("p" + i + "b" + j).value.replaceAll("%", "\\%")
      );
    }
